                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-fex flex-column vote-controls">
                            ...
                            {{--  Hidden form for submmiting request and directing to update/create uri --}}
                            <form id="up-down-question-{{ $question->id }}" action="/questions/{{ $question->id }}/vote" method="POST" style="display:none;">
                                @csrf
                                <input type="hidden" value="-1" name="vote">
                            </form>
                            ...
                            <a title="Click to mark as favorite question (Click again to undo)" 
                                ...
                                {{-- onclick event to trigger submit button of favorite-question form --}}
                                onclick="event.preventDefault(); document.getElementById('favorite-question-{{ $question->id }}').submit();"
                                >
                                <i class="fas fa-star fa-2x"></i>
                                <span class="favorites-count">{{ $question->favorites_count }}</span>
                            </a>
                            {{-- {{$question->testfavorited}} --}}
